  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>
        ...
        Cette ressource est développée dans le cadre
        du <a href="https://www.epfl.ch/education/educational-initiatives/fr/le-projet-edunum-le-cas-si/cas-si/" target="_blank" rel="noreferrer">
          CAS pour l'enseignement de la Science Informatique en secondaire 1
        </a> (CAS SI) créé par
        le <a href="http://learn.epfl.ch/" target="_blank" rel="noreferrer">
          Centre LEARN
        </a> de <a href="https://www.epfl.ch/fr/" target="_blank" rel="noreferrer">l'École Polytechnique Fédérale de Lausanne</a> (EPFL) dans le cadre du projet EduNum du canton de Vaud en Suisse.
      </p>
      <p>
